...
<%--                </div><a class="ps-logo" href="index.html"><img src="${pageContext.servletContext.contextPath}/img/logo_light.png" alt=""></a></div>--%>
    ...
    <div class="header__center">
            ...
            <div class="header__right">
                <div class="header__actions"><a class="header__extra" href="#"><i class="icon-chart-bars"></i><span><i>0</i></span></a><a href="${pageContext.servletContext.contextPath}/product/whishlist" id="countWhish" class="header__extra" href="#"><i class="icon-heart"></i><span><i>0</i></span></a>
