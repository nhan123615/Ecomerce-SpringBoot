        ...
        <div class="ps-cart--mobile">
            <div class="ps-cart__content"  >
                ...
                <div class="ps-cart__footer">
                    ...
                    <figure><a class="ps-btn" href="shopping-cart.html">View Cart</a><a class="ps-btn" href="${pageContext.servletContext.contextPath}/customer/product/checkout">Checkout</a></figure>
                </div>
            </div>
