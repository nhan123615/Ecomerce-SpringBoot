			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						...
						<!-- form start -->
						<form
							action="${pageContext.servletContext.contextPath}/admin1/product/update"
							...
							<div class="card-body">
								...
								<div class="form-group">
									<label for="images">Image</label> <br /> <input type="file" id="img"
										name="img" > <img
										src="${pageContext.request.contextPath}/admin1/product/display/0&${product.id}"
										width="200" height="200" />
								</div>
								<div class="form-group">
									<label for="images">Image</label> <br /> <input type="file" id="img1"
										name="img" > <img
										src="${pageContext.request.contextPath}/admin1/product/display/1&${product.id}"
										width="200" height="200" />
								</div>
								<div class="form-group">
									<label for="images">Image</label> <br /> <input type="file" id="img2"
										name="img" > <img
										src="${pageContext.request.contextPath}/admin1/product/display/2&${product.id}"
										width="200" height="200" />
								</div>
								<div class="form-group">
									<label for="images">Image</label> <br /> <input type="file" id="img3"
										name="img" > <img
										src="${pageContext.request.contextPath}/admin1/product/display/3&${product.id}"
										width="200" height="200" />
								</div>
								<div class="form-group">
