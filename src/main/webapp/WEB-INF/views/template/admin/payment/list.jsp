...
<%@ page import="com.coeding.entity.Payment"%>
		...
		<div class="content-wrapper" style="min-height: 116.365px;">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Payment Manager :: List</h1>
						</div>
					</div>
				</div>
			</div>
								...
								<table
									...
									<thead>
										<tr>
											...
											<th class="text-center">Customer Order Id</th>
										...
										<c:forEach items="${paymentList}" var="p">
											<tr>
												...
												<td class="text-center"><a
													href="${pageContext.servletContext.contextPath}/admin/payment/detail?id=${p.id}"
